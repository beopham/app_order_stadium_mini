...
public class DatSanChiTietActivity extends AppCompatActivity {
        ...
        if (count <= 0) {
            ...
            if (!isUpdate) {
                if (customer == null) {
                    ...
                    int total =  + totalMoneyService + chiPhiKhac +totalMoneyPitch;
    ...
    public String getThu() {
        ...
        switch (dayOfWeek) {
            case 1:
                return "Chủ Nhật " + datePlay;
            case 2:
                return "Thứ 2 " + datePlay;
            case 3:
                return "Thứ 3 " + datePlay;
            case 4:
                return "Thứ 4 " + datePlay;
            case 5:
                return "Thứ 5 " + datePlay;
            case 6:
                return "Thứ 6 " + datePlay;
            case 7:
                return "Thứ 7 " + datePlay;
            default:
                return "";
        }
    }
